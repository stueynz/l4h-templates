 ...
 * 
 * This edition of CentralRegionUtils uses the public FHIR ConceptMap $translate API to do the conceptMap
 * code translations.
 * 
 * The real edition of CentralRegionUtils will make native SmileCDR API calls to do the translations.
 * 
...
public class CentralRegionUtils {
    ...
    // The code generators at HL7 FHIR Headquarters didn't generate any methods for
    // extracting a Part from a ParametersComponent
    // by name. So we have to write it ourselves - yuck !!
    private static Type getPartNamed(ParametersParameterComponent component, String name) {
        for (ParametersParameterComponent item : component.getPart()) {
